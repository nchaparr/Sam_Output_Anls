...
Ax1.set_xlabel( r'$\frac{\overline{w^{\prime}\theta^{\prime}}}{\overline{w^{\prime}\theta^{\prime}}_{s}}$', fontsize=20)
...
height_file = "/newtera/tera/phil/nchaparr/python/Plotting/"+date+"/data/heights0000018000"
...
for i in range(len(theta_file_list)):    
    ...
    if np.mod(i+1, 6) == 0:
        ...
        Ax1.plot(dthetadz, height, '-', label = str(Times[i])+'hrs')        
