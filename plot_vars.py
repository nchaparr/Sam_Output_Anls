...
Ax1.set_title(r'Scaled Root Mean Velocity Squared - 1 hours')
...
u_file_list = ["/tera/phil/nchaparr/python/Plotting/Dec252013/data/rootmeanusq"+ dump_time for dump_time in dump_time_list] 
v_file_list = ["/tera/phil/nchaparr/python/Plotting/Dec252013/data/rootmeanvsq"+ dump_time for dump_time in dump_time_list]
w_file_list = ["/tera/phil/nchaparr/python/Plotting/Dec252013/data/rootmeanwsq"+ dump_time for dump_time in dump_time_list]
...
height_file = "/tera/phil/nchaparr/python/Plotting/Dec252013/data/heights0000028800"
...
for i in range(len(flux_file_list)):    
    ...
    invrinos = np.genfromtxt('/tera/phil/nchaparr/python/Plotting/Dec252013/data/invrinos')
    AvProfLims = np.genfromtxt('/tera/phil/nchaparr/python/Plotting/Dec252013/data/AvProfLims')
    height = np.genfromtxt(height_file)
    zeros = np.zeros_like(height)
    
    if np.mod(i+1, 1) ==0 and i == 5:
