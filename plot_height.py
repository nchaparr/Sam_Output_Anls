...
Ax3.plot(1.0/rinovals[11:, 3], dhdtplot[:, 1], 'kv', label = '100/10')
Ax3.plot(1.0/rinovals0[7:, 3], dhdtplot0[:, 1],'ko', label = '100/5')
Ax3.plot(1.0/rinovals1[11:, 3], dhdtplot1[:, 1],'yo', label = '60/5')
Ax3.plot(1.0/rinovals2[11:, 3], dhdtplot2[:, 1],'y*', label = '60/2.5')
Ax3.plot(1.0/rinovals3[11:29, 3], dhdtplot3[:18, 1],'ro', label = '150/5')
Ax3.plot(1.0/rinovals4[11:, 3], dhdtplot4[:, 1],'yv', label = '60/10')
Ax3.plot(1.0/rinovals5[11:, 3], dhdtplot5[:, 1],'rv', label = '150/10')
