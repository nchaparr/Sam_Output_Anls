...
Ax3.plot(np.divide(np.array(Times[11:])*3600, rinovals[11:,4]), AvProfVars[11:,1], linestyle='none', marker = 'v', color = 'k', label = '100/10')
Ax3.plot(np.divide(np.array(Times0[7:])*3600, rinovals0[7:,4]), AvProfVars0[7:,1], linestyle='none', marker = 'o', color = 'k', label = '100/5')
Ax3.plot(np.divide(np.array(Times[11:])*3600, rinovals1[11:,4]), AvProfVars1[11:,1], linestyle='none', marker = 'o', color = 'y', label = '60/5')
Ax3.plot(np.divide(np.array(Times[11:])*3600, rinovals2[11:,4]), AvProfVars2[11:,1], linestyle='none', marker = '*', color = 'y', label = '60/2.5')
Ax3.plot(np.divide(np.array(Times[11:])*3600, rinovals3[11:,4]), AvProfVars3[11:,1], linestyle='none', marker = 'o', color = 'r', label = '150/5')
Ax3.plot(np.divide(np.array(Times[11:])*3600, rinovals4[11:,4]), AvProfVars4[11:,1], linestyle='none', marker = 'v', color = 'y', label = '60/10')
Ax3.plot(np.divide(np.array(Times[11:])*3600, rinovals5[11:,4]), AvProfVars5[11:,1], linestyle='none', marker = 'v', color = 'r', label = '150/10')
