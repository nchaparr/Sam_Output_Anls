...
Ax3.plot(rinovals[11:, 1], Deltah0[11:], 'kv', label = '100/10', markersize=10)
Ax3.plot(rinovals0[7:, 1], Deltah00[7:],'ko', label = '100/5', markersize=10)
Ax3.plot(rinovals1[11:, 1], Deltah01[11:],'yo', label = '60/5', markersize=10)
Ax3.plot(rinovals2[11:, 1], Deltah02[11:],'y*', label = '60/2.5', markersize=10)
Ax3.plot(rinovals3[11:29, 1], Deltah03[11:29],'ro', label = '150/5', markersize=10)
Ax3.plot(rinovals4[11:, 1], Deltah04[11:],'yv', label = '60/10', markersize=10)
Ax3.plot(rinovals5[11:, 1], Deltah05[11:],'rv', label = '150/10', markersize=10)
...
Ax3.set_ylabel(r"$\frac{\Delta h}{h}$", fontsize=25)
...
Ax3.set_xlabel(r"$Ri_{\Delta}^{-1}$", fontsize=25)
