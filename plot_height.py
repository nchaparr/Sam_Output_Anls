...
FitFunc=np.polyfit(Times[11:], AvProfVars4[11:, 1], 2, full=False)
...
deltah = np.subtract(AvProfVars4[:, 2], AvProfVars4[:, 0])
deltah = np.divide(deltah, AvProfVars4[:, 1])
tau = 1.0*rinovals4[:,4]/3600
scaled_time = np.divide(Times, tau)
scaled_dhdt = np.divide(dhdt, rinovals4[11:, 2])
dhdtinvriplt = np.vstack((rinovals4[11:, 1], scaled_dhdt))
dhdtinvriplt = np.transpose(np.vstack((dhdtinvriplt,deltah[11:])))
#np.savetxt('/tera/phil/nchaparr/python/Plotting/Mar12014/data/dhdtinvriplt.txt', dhdtinvriplt, delimiter=' ')

#Ax3.plot(dhdtplot[:, 1], dhdtplot[:,0], 'ko', label = '100/10')
#Ax3.plot(dhdtplot0[:, 1], dhdtplot0[:,0], 'ro', label = '100/5')
#Ax3.plot(dhdtplot1[:, 1], dhdtplot1[:,0], 'bo', label = '60/5')
#Ax3.plot(dhdtplot2[:, 1], dhdtplot2[:,0], 'yo', label = '60/2.5')
#Ax3.plot(dhdtplot3[:, 1], dhdtplot3[:,0], 'go', label = '150/5')
#Ax3.plot(dhdtplot4[:, 1], dhdtplot4[:,0], 'co', label = '60/10')
...
Ax3.plot(Times[11:], Deltah0[11:,5], 'ko', label = '100/10')
Ax3.plot(Times0[7:], Deltah00[7:,5], 'ro', label = '100/5')
Ax3.plot(Times[11:], Deltah01[11:,5], 'bo', label = '60/5')
Ax3.plot(Times[11:], Deltah02[11:,5], 'yo', label = '60/2.5')
Ax3.plot(Times[11:], Deltah03[11:,5],'go', label = '150/5')
Ax3.plot(Times[11:], Deltah04[11:,5],'co', label = '60/10')
