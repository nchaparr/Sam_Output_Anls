...
Ax3.plot(Times[11:29], Deltah03[11:29], 'ro', label = '150/5')
...
#Ax3.plot(Times[11:], AvProfVars[11:,0], linestyle='none', marker = 'v', color = 'k', label = '100/10')
#Ax3.plot(Times[11:], AvProfVars[11:,2], linestyle='none', marker = 'v', color = 'k')
#Ax3.plot(Times0[7:], AvProfVars0[7:,0], linestyle='none', marker = 'o', color = 'k', label = '100/5')
#Ax3.plot(Times0[7:], AvProfVars0[7:,2], linestyle='none', marker = 'o', color = 'k')
#Ax3.plot(Times[11:], AvProfVars1[11:,0], linestyle='none', marker = 'o', color = 'y', label = '60/5')
#Ax3.plot(Times[11:], AvProfVars1[11:,2], linestyle='none', marker = 'o', color = 'y')
#Ax3.plot(Times[11:], AvProfVars2[11:,0], linestyle='none', marker = '*', color = 'y', label = '60/2.5')
#Ax3.plot(Times[11:], AvProfVars2[11:,2], linestyle='none', marker = '*', color = 'y')
#Ax3.plot(Times[11:29], AvProfVars3[11:29,0], linestyle='none', marker = 'o', color = 'r', label = '150/5')
#Ax3.plot(Times[11:29], AvProfVars3[11:29,2], linestyle='none', marker = 'o', color = 'r')
#Ax3.plot(Times[11:], AvProfVars4[11:,0], linestyle='none', marker = 'v', color = 'y', label = '60/10')
#Ax3.plot(Times[11:], AvProfVars4[11:,2], linestyle='none', marker = 'v', color = 'y')
#Ax3.plot(Times[11:], AvProfVars5[11:,0], linestyle='none', marker = 'v', color = 'r', label = '150/10')
#Ax3.plot(Times[11:], AvProfVars5[11:,2], linestyle='none', marker = 'v', color = 'r')
