...
xes = np.arange(0.027, .045, .0001)
x1es = np.arange(.045, .075, .0001)
ys = 2.6*xes**(1.5)
ys1= .55*x1es**(1)
Ax3.loglog(xes, ys, 'k--')
...
Ax3.text(.028, .019, r'$a = -\frac{3}{2}$',  fontdict=None, withdash=False, fontsize = 30, rotation=43)

Ax3.text(.046, .034, r'$a = -1$',  fontdict=None, withdash=False, fontsize = 30, rotation=31)
...
Ax3.set_xticks([.04, .06, .08, .1])
Ax3.set_xticklabels([.04, .06, .08, .1])
