...
Ax3.plot(Times[11:], 1.0/rinovals[11:, 3], 'kv', label = '100/10')
Ax3.plot(Times0[7:], 1.0/rinovals0[7:, 3], 'ko', label = '100/5')
Ax3.plot(Times[11:], 1.0/rinovals1[11:, 3], 'yo', label = '60/5')
Ax3.plot(Times[11:], 1.0/rinovals2[11:, 3], 'y*', label = '60/2.5')
Ax3.plot(Times[11:29], 1.0/rinovals3[11:29, 3], 'ro', label = '150/5')
Ax3.plot(Times[11:], 1.0/rinovals4[11:, 3], 'yv', label = '60/10')
Ax3.plot(Times[11:], 1.0/rinovals5[11:, 3], 'rv', label = '150/10')
