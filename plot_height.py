...
xes = np.arange(0.09, .15, .0001)
x1es = np.arange(0.14, .3, .0001)
ys = .46*xes**(1.5)
ys1= .07*x1es**(1)
Ax3.loglog(xes, ys, 'k--')
...
Ax3.text(.1, .02, r'$a = -\frac{3}{2}$',  fontdict=None, withdash=False, fontsize = 15)

Ax3.text(.2, .013, r'$a = -1$',  fontdict=None, withdash=False, fontsize = 15)
