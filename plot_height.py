...
xes = np.arange(.04, .09, .0001)
x1es = np.arange(.035, .07, .0001)
ys = .05*xes**(.5)
ys1= .5*x1es**(1)
Ax3.loglog(xes, ys, 'k--')
...
Ax3.text(.05, .03, r'$a = -1$',  fontdict=None, withdash=False, fontsize = 15)

Ax3.text(.06, .011, r'$a = -\frac{1}{2}$',  fontdict=None, withdash=False, fontsize = 15)
