...
xes = np.arange(0.085, .2, .0001)
x1es = np.arange(.08, .2, .0001)
#ys = 2.1*xes**(1.5)
ys1= .14*x1es**(1)
#Ax3.loglog(xes, ys, 'k--')
...
Ax3.text(.08, .02, r'$a = -1$',  fontdict=None, withdash=False, fontsize = 30, rotation=34)
...
#Ax3.set_xticklabels([.2, .4, .6, .8, 1])
#Ax3.set_yticks([.02, .04, .06, .08, .1])
#Ax3.set_yticklabels([.02, .04, .06, .08, .1])
