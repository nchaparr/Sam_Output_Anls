...
xes = np.arange(0.033, .05, .0001)
x1es = np.arange(.05, .09, .0001)
ys = 2.1*xes**(1.5)
ys1= .47*x1es**(1)
Ax3.loglog(xes, ys, 'k--')
...
Ax3.text(.055, .038, r'$a = -1$',  fontdict=None, withdash=False, fontsize = 30, rotation=20)

Ax3.text(.033, .02, r'$a = -\frac{3}{2}$',  fontdict=None, withdash=False, fontsize = 30, rotation=28)
