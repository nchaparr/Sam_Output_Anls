...
Ax3.plot(rinovals[11:, 1], dhdtplot[:, 1], 'kv', label = '100/10')
Ax3.plot(rinovals0[7:, 1], dhdtplot0[:, 1],'ko', label = '100/5')
Ax3.plot(rinovals1[11:, 1], dhdtplot1[:, 1],'yo', label = '60/5')
Ax3.plot(rinovals2[11:, 1], dhdtplot2[:, 1],'y*', label = '60/2.5')
Ax3.plot(rinovals3[11:29, 1], dhdtplot3[:18, 1],'ro', label = '150/5')
Ax3.plot(rinovals4[11:, 1], dhdtplot4[:, 1],'yv', label = '60/10')
Ax3.plot(rinovals5[11:, 1], dhdtplot5[:, 1],'rv', label = '150/10')
