...
#Ax3.plot(rinovals[11:, 1], Deltah0[11:], 'ko', label = '100/10')
#Ax3.plot(rinovals0[7:, 1], Deltah00[7:], 'ro', label = '100/5')
#Ax3.plot(rinovals1[11:, 1], Deltah01[11:], 'bo', label = '60/5')
#Ax3.plot(rinovals2[11:, 1], Deltah02[11:], 'yo', label = '60/2.5')
#Ax3.plot(rinovals3[11:, 1], Deltah03[11:], 'go', label = '150/5')
...
Ax3.plot(Times[11:], Deltah0[11:], 'ko', label = '100/10')
Ax3.plot(Times0[7:], Deltah00[7:], 'ro', label = '100/5')
Ax3.plot(Times[11:], Deltah01[11:], 'bo', label = '60/5')
Ax3.plot(Times[11:], Deltah02[11:], 'yo', label = '60/2.5')

Ax3.plot(Times[11:], Deltah03[11:],'go', label = '150/5')
...
Ax3.set_title(r'$\Delta h \ vs \ Time$', fontsize=20)
