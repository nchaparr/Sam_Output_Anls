...
Ax3.plot(np.divide(np.array(Times[:])*3600, rinovals[:,4]), AvProfVars[:,1], linestyle='none', marker = 'v', color = 'k', label = '100/10')
Ax3.plot(np.divide(np.array(Times0[:])*3600, rinovals0[:,4]), AvProfVars0[:,1], linestyle='none', marker = 'o', color = 'k', label = '100/5')
Ax3.plot(np.divide(np.array(Times[:])*3600, rinovals1[:,4]), AvProfVars1[:,1], linestyle='none', marker = 'o', color = 'y', label = '60/5')
Ax3.plot(np.divide(np.array(Times[:])*3600, rinovals2[:,4]), AvProfVars2[:,1], linestyle='none', marker = '*', color = 'y', label = '60/2.5')
Ax3.plot(np.divide(np.array(Times[:])*3600, rinovals3[:,4]), AvProfVars3[:,1], linestyle='none', marker = 'o', color = 'r', label = '150/5')
Ax3.plot(np.divide(np.array(Times[:])*3600, rinovals4[:,4]), AvProfVars4[:,1], linestyle='none', marker = 'v', color = 'y', label = '60/10')
Ax3.plot(np.divide(np.array(Times[:])*3600, rinovals5[:,4]), AvProfVars5[:,1], linestyle='none', marker = 'v', color = 'r', label = '150/10')
...
Ax3.set_ylabel(r"$\frac{Time}{\tau}$", fontsize=20)
