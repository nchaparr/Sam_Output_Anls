...
Ax3.plot(HistVars[0], HistVars[5], 'kv', label = '100/10')
Ax3.plot(HistVars0[0], HistVars0[5],'ko', label = '100/5')
Ax3.plot(HistVars1[0], HistVars1[5],'yo', label = '60/5')
Ax3.plot(HistVars2[0], HistVars2[5],'y*', label = '60/2.5')
Ax3.plot(HistVars3[0], HistVars3[5],'ro', label = '150/5')
Ax3.plot(HistVars4[0], HistVars4[5],'yv', label = '60/10')
Ax3.plot(HistVars5[0], HistVars5[5],'rv', label = '150/10')
...
Ax3.set_ylabel(r"$\sigma^{2}$", fontsize=20)
