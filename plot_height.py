...
dhdtplot = np.genfromtxt("/tera/users/nchaparr/Dec142013/data/dhdtinvriplt.txt") 
dhdtplot0 = np.genfromtxt("/tera/users/nchaparr/Nov302013/data/dhdtinvriplt.txt")
dhdtplot1 = np.genfromtxt("/tera/users/nchaparr/Dec202013/data/dhdtinvriplt.txt")
dhdtplot2 = np.genfromtxt("/tera/users/nchaparr/Dec252013/data/dhdtinvriplt.txt")
dhdtplot3 = np.genfromtxt("/tera/users/nchaparr/Jan152014_1/data/dhdtinvriplt.txt")
dhdtplot4 = np.genfromtxt("/tera/users/nchaparr/Mar12014/data/dhdtinvriplt.txt")
dhdtplot5 = np.genfromtxt("/tera/users/nchaparr/Mar52014/data/dhdtinvriplt.txt")
...
AvProfVars = np.genfromtxt("/tera/users/nchaparr/Dec142013/data/AvProfLims")
AvProfVars0 = np.genfromtxt("/tera/users/nchaparr/Nov302013/data/AvProfLims")
AvProfVars1 = np.genfromtxt("/tera/users/nchaparr/Dec202013/data/AvProfLims")
AvProfVars2 = np.genfromtxt("/tera/users/nchaparr/Dec252013/data/AvProfLims")
AvProfVars3 = np.genfromtxt("/tera/users/nchaparr/Jan152014_1/data/AvProfLims")
AvProfVars4 = np.genfromtxt("/tera/users/nchaparr/Mar12014/data/AvProfLims")
AvProfVars5 = np.genfromtxt("/tera/users/nchaparr/Mar52014/data/AvProfLims")

rinovals = np.genfromtxt("/tera/users/nchaparr/Dec142013/data/invrinos")
rinovals0 = np.genfromtxt("/tera/users/nchaparr/Nov302013/data/invrinos")
rinovals1 = np.genfromtxt("/tera/users/nchaparr/Dec202013/data/invrinos")
rinovals2 = np.genfromtxt("/tera/users/nchaparr/Dec252013/data/invrinos")
rinovals3 = np.genfromtxt("/tera/users/nchaparr/Jan152014_1/data/invrinos")
rinovals4 = np.genfromtxt("/tera/users/nchaparr/Mar12014/data/invrinos")
rinovals5 = np.genfromtxt("/tera/users/nchaparr/Mar52014/data/invrinos")
