...
xes = np.arange(0.028, .045, .0001)
x1es = np.arange(.045, .08, .0001)
ys = 2.7*xes**(1.5)
ys1= .57*x1es**(1)
Ax3.loglog(xes, ys, 'k--')
...
Ax3.text(.05, .041, r'$a = -1$',  fontdict=None, withdash=False, fontsize = 30, rotation=14)

Ax3.text(.03, .024, r'$a = -\frac{3}{2}$',  fontdict=None, withdash=False, fontsize = 30, rotation=22)
