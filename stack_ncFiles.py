...
ncFile_names = glob.glob('/tera/phil/nchaparr/sam_ensemble/sam_case1/OUT_3D/NCHAPP1*nc')
...
#variables to stack
varnames = ['TRACER']
outfile = '/tera/phil/nchaparr/sam_ensemble/sam_case1/OUT_3D/stacked_tracer.nc'
print 'creating new file: ', outfile
nc_out = initialize_ncFile(outfile, varnames[0],  xlen, ylen, zlen, tlen)
