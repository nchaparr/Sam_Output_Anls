...
ax.scatter(rinovals[11:,1], Deltah0[11:], rinovals[11:,7], c='k', marker='v', label = '100/10')
ax.scatter(rinovals0[7:,1], Deltah00[7:], rinovals0[7:,7], c='k', marker='o', label = '100/5')
ax.scatter(rinovals1[11:,1], Deltah01[11:], rinovals1[11:,7], c='y', marker='o', label = '60/5')
ax.scatter(rinovals2[11:,1], Deltah02[11:], rinovals2[11:,7], c='y', marker='*', label = '60/2.5')
ax.scatter(rinovals3[11:29,1], Deltah03[11:29], rinovals3[11:29,7], c='r', marker='o', label = '150/5')
ax.scatter(rinovals4[11:,1], Deltah04[11:], rinovals4[11:,7], c='y', marker='v', label = '60/10')
ax.scatter(rinovals5[11:,1], Deltah05[11:], rinovals5[11:,7], c='r', marker='v', label = '150/10')
